...
const Navbar = () => {
    ...
    const stickNavbar = ()=>{
        if (window !== undefined) {
            ...
            windowHeight > 80 ? setStickyClass('h-[70px] border-b fixed top-0 bg-white border-gray-200 shadow-md z-50 ') : setStickyClass('absolute top-0 z-50');
        }
    }
  ...
  return (
    <div className={`w-full  ${stickyClass} `}>
        <div className='container flex mx-auto px-4 py-2 justify-between items-center'>
                <div>
                   <h1 className='font-extrabold text-3xl capitalize  text-blue-600 px-2 py-2'>sitelogo</h1> 
                </div>
