    ...
    <div className='w-full mt-20 flex justify-center items-center'>
        ...
        <form className="w-full"> 
              <div className='w-full grid grid-cols-2'>  
                    ...
                    <Form name='name' placeholder='Company Name' label='Company Name' />
                    <p className="text-gray-500 text-sm pt-0 italic">Please fill in your company name.</p>
                    </div>
                    <div className="w-full px-3">
                        <Form name='location' placeholder='your company HQ location' label='Company HQ'/>
                        <p className="text-gray-500 text-sm pt-0  italic">Where your company is officially headquartered.</p>
                    </div>
                    <div className="w-full  px-3 mb-6 md:mb-0">
                    <Form name='website' placeholder='Company Website ' label='Company Website URL' />
                    
                    </div>
                    <div className="w-full px-3">
                        <Form name='email' placeholder='your company email' label='Email'/>
                    </div>
                </div>
                <div className='mb-4'>
                   <label className='block px-4 text-gray-700 text-sm font-medium font-sans mb-2'>Company Logo</label>
                   <input type="file" name="logo"  placeholder="company logo" className='text-lg shadow appearance-none border-none rounded w-full py-4 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'/> 
                 </div>
                 <div className='px-2'>
